...
%	% ---
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.5 \textwidth]{ET1_2Gradata-1.png}
		\caption{原始数据1}
		\label{fig:figdata-1}
	\end{figure}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.5 \textwidth]{ET1_2Gradata-2.png}
		\caption{原始数据2}
		\label{fig:figdata-2}
	\end{figure}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.5 \textwidth]{ET1_2Gradata-3.png}
		\caption{原始数据3}
		\label{fig:figdata-3}
	\end{figure}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.5 \textwidth]{ET1_2Gradata-4.png}
		\caption{原始数据4}
		\label{fig:figdata-4}
	\end{figure}
